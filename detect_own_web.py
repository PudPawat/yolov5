            ...
            if opt.command =="True" and cmd == ord("c"):
                ...
                for i, det in enumerate(pred):  # detections per image
                    ...
                    if det is not None and len(det):
                        ...
                        df_cls_info.to_csv('X:/Desktop/test/class_num_'+dt_string+'.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train_cig/web/best (1).pt', help='model.pt path(s)') #yolov5s.pt
    ...
    parser.add_argument('--collect', default='True', help= 'to collect data during running program')
